...
//     private static final String[] AdminOnlyEndpoints = {
//         "/api/services/**" // Endpoints for adding, updating, and deleting services
//     };

//     private static final String[] AuthenticatedEndpoints = {
//         "/api/bookings/**" // Endpoints related to bookings
//     };
...
//                         .requestMatchers(AdminOnlyEndpoints).hasRole("ADMIN") // Admin-only endpoints
//                         .requestMatchers(AuthenticatedEndpoints).authenticated() // Authenticated endpoints
